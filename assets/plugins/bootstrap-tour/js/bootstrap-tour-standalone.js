    ...
    if (this.hasContent() && this.enabled) {
      ...
      if (autoPlace) {
        ...
        $tip
          ...
          .addClass(placement).addClass('popover-'+placement);
      }
  ...
  Tour = (function() {
    function Tour(options) {
      ...
      this._options = $.extend({
        ...
        delay: false,
        basePath: '',
        template: '<div class="popover" role="tooltip"> <div class="arrow"></div> <h3 class="popover-title text-success"></h3> <div class="popover-content"></div> <div class="popover-navigation"> <div class="btn-group"> <button class="btn btn-sm btn-primary" data-role="prev"><i class="fa fa-arrow-circle-left" ></i> Prev</button> <button class="btn btn-sm btn-secondary disabled text-center" disabled data-role="page" >1/1</button> <button class="btn btn-sm green" data-role="next">Next <i class="fa fa-arrow-circle-right"></i></button> <button class="btn btn-sm btn-default" data-role="pause-resume" data-pause-text="Pause" data-resume-text="Resume">Pause</button> </div> <button class="btn btn-sm btn-danger" data-role="end">End Wizard</button> </div> </div>',
    ...
    Tour.prototype._showPopover = function(step, i) {
      ...
      $element.popover({
        ...
        trigger: 'manual',
        title: '<i class="fa fa-lightbulb-o"></i> '+step.title,
    ...
    Tour.prototype._template = function(step, i) {
      ...
      $template.addClass("popover-"+step.placement);
      ...
      $navigation.find('[data-role="page"]').html((i+1)+'/'+this._options.steps.length);
