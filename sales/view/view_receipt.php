...
label_cells(_("Amount"), number_total($receipt['Total'] - $receipt['ov_discount']), "class='tableheader2'");
label_cells(_("Discount"), number_total($receipt['ov_discount']), "class='tableheader2'");
end_row();
start_row();
label_cells(_("Into Bank Account"), $receipt['bank_account_name'].' ['.$receipt['bank_curr_code'].']', "class='tableheader2'");
label_cells(_("Bank Amount"), number_total($receipt['bank_amount']), "class='tableheader2'");
label_cells(_("Payment Type"), $bank_transfer_types[$receipt['BankTransType']], "class='tableheader2'");
end_row();
start_row();
label_cells(_("Cheque No."), $receipt['cheque'], "class='tableheader2'");
end_row();
