...
class renderer
{
    ...
    {
        global $assets_path;
        $this->theme_uri = '//' . $_SERVER['HTTP_HOST'] . '/themes/uniq365';
        $this->theme_img_uri = '//' . $_SERVER['HTTP_HOST'] . '/themes/uniq365/images';
	...
	add_js_file($assets_path . '/js/syncard.js');
            ...
            foreach ($applications as $app) {
                if ($app->id != 'Dashboard') {
                    ...
                    if( $dashboard_uri=="products/dashboard"
                        ...
                        echo '<li class="dropdownWithHref a" ><a target="_blank" href="http://xersolutionhr.com/Account/Login.aspx?hrm='.md5(date('dmY')).'" ><img src="' . $this->theme_img_uri . '/menuicon_03.png" ><span>HRM</span></a></li>';
                    }
                }
            }
