    ...
    _markup =
        '<div class="ui-widget-header ui-helper-clearfix ui-corner-all">' +
            '<table class="month-picker-year-table" width="100%" border="0" cellspacing="1" cellpadding="2">' +
                '<tr>' +
                    '<td class="previous-year">'+
                    '<button class="ui-button ui-widget ui-state-default ui-corner-all ui-button-icon-only" role="button" aria-disabled="false" title="Previous Year"><span class="ui-button-icon-primary ui-icon ui-icon-circle-triangle-w">Prev</span><span class="ui-button-text">&nbsp;</span></button>'+
                    '</td>' +
                    ...
                    '</td>' +
                    '<td class="next-year">\n\
        <button class="ui-button ui-widget ui-state-default ui-corner-all ui-button-icon-only" role="button" aria-disabled="false" title="Next Year"><span class="ui-button-icon-primary ui-icon ui-icon-circle-triangle-e">Next</span><span class="ui-button-text">&nbsp;</span></button>\n\
</td>' +
                '</tr>' +
            '</table>' +
        '</div>' +
        '<div class="ui-widget ui-widget-content ui-helper-clearfix ui-corner-all">' +
            '<table class="month-picker-month-table" width="100%" border="0" cellspacing="1" cellpadding="2">' +
                '<tr>' +
                    '<td><button type="button" class="button-1 ui-button ui-widget ui-state-default ui-corner-all ui-button-text-only" role="button" aria-disabled="false"><span class="ui-button-text">Jan.</span></button></td>' +
                    '<td><button class="button-2 ui-button ui-widget ui-state-default ui-corner-all ui-button-text-only ui-state-hover" type="button" role="button" aria-disabled="false"><span class="ui-button-text">Feb.</span></button></td>' +
                    '<td><button class="button-3 ui-button ui-widget ui-state-default ui-corner-all ui-button-text-only ui-state-hover" type="button" role="button" aria-disabled="false"><span class="ui-button-text">Mar.</span></button></button></td>' +
                '</tr>' +
                '<tr>' +
                    '<td><button class="button-4 ui-button ui-widget ui-state-default ui-corner-all ui-button-text-only ui-state-hover" type="button" role="button" aria-disabled="false"><span class="ui-button-text">Apr.</span></button></td>' +
                    '<td><button class="button-5 ui-button ui-widget ui-state-default ui-corner-all ui-button-text-only ui-state-hover" type="button" role="button" aria-disabled="false"><span class="ui-button-text">May</span></button></td>' +
                    '<td><button class="button-6 ui-button ui-widget ui-state-default ui-corner-all ui-button-text-only ui-state-hover" type="button" role="button" aria-disabled="false"><span class="ui-button-text">June</span></button></td>' +
                '</tr>' +
                '<tr>' +
                    '<td><button class="button-7 ui-button ui-widget ui-state-default ui-corner-all ui-button-text-only" type="button" role="button" aria-disabled="false"><span class="ui-button-text">July</span></button></td>' +
                    '<td><button class="button-8 ui-button ui-widget ui-state-default ui-corner-all ui-button-text-only ui-state-hover" type="button" role="button" aria-disabled="false"><span class="ui-button-text">Aug.</span></button></td>' +
                    '<td><button class="button-9 ui-button ui-widget ui-state-default ui-corner-all ui-button-text-only ui-state-hover" type="button" role="button" aria-disabled="false"><span class="ui-button-text">Sep.</span></button></td>' +
                '</tr>' +
                '<tr>' +
                    '<td><button class="button-10 ui-button ui-widget ui-state-default ui-corner-all ui-button-text-only ui-state-hover" type="button" role="button" aria-disabled="false"><span class="ui-button-text">Oct.</span></button></button></td>' +
                    '<td><button class="button-11 ui-button ui-widget ui-state-default ui-corner-all ui-button-text-only ui-state-hover" type="button" role="button" aria-disabled="false"><span class="ui-button-text">Nov.</span></button></td>' +
                    '<td><button class="button-12 ui-button ui-widget ui-state-default ui-corner-all ui-button-text-only ui-state-hover" type="button" role="button" aria-disabled="false"><span class="ui-button-text">Dec.</span></button></td>' +
                '</tr>' +
            '</table>' +
        '</div>';
        ...
        _showIcon: function () {
            if (this._monthPickerButton === null) {
                if (this.options.ShowIcon) {
                    //this._monthPickerButton = $('<span id="MonthPicker_Button_' + this.element.attr('id') + '" class="month-picker-open-button  ui-button ui-widget ui-state-default ui-corner-all ui-button-icon-only">' + this._i18n('buttonText') + '</span>').insertAfter(this.element);
                    //this._monthPickerButton = $('<span id="MonthPicker_Button_' + this.element.attr('id') + '" class="month-picker-open-button  ui-button ui-widget ui-state-default ui-corner-all ui-button-icon-only">' + this._i18n('buttonText') + '<span class="ui-button-icon-primary ui-icon ui-icon-calculator"></span><span class="ui-button-text">Open Month Chooser</span></span>').insertAfter(this.element);
                	this._monthPickerButton = $('<img width="16" border="0" height="16" src="/themes/default/images/cal.gif" alt="Click Here to Pick up the date">').insertAfter(this.element);
...
//                this.element.val(month + '/' + this._getPickerYear()).change();
//            }
            console.log(month + date_separator + this._getPickerYear());
            this.element.val(month + date_separator + this._getPickerYear()).change();
//            this.element.blur();
