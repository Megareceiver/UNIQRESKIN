...
function get_templates()
    {
        ...
        $.ajax({
            type: "POST",
            url: "<?php echo site_url('report/report/get_templates_credit_note'); ?>",
            dataType: "json",
 ...
 function use_template()
    {
        ...
        $.ajax({
            type: "POST",
            url: "<?php echo site_url('report/report/use_template_credit_note'); ?>",
            dataType: "json",
            data: data,
            success: function (data)
            {
    ...
    function delete_template() {
        ...
        $.ajax({
            type: "POST",
            url: "<?php echo site_url('report/report/delete_template_credit_note'); ?>",
            dataType: "json",
            data: data,
            success: function (data)
            {
...
function submitForm() {
        ...
        $.ajax({
            url: "<?php echo site_url("report/report/do_upload_credit_note")?>",
            type: "POST",
            data: datasend,
            processData: false,
            contentType: false
        ...
        <div class="panel">
            <div class="col-md-12">
                ...
                <div class="panel-body" style="text-transform: uppercase;">
                    <div class="form-body form-horizontal justify-content-center">
                        <div class="pb-2">
                        <a href="<?php echo site_url() ?>company/words/31a9c8a2f605f9690bbd5098977d7a87.docx" >
