...
function get_templates()
    {
        ...
        $.ajax({
            type: "POST",
            url: "<?php echo site_url('report/report/get_templates_bank_reconcile'); ?>",
            dataType: "json",
 ...
 function use_template()
    {
        ...
        $.ajax({
            type: "POST",
            url: "<?php echo site_url('report/report/use_template_bank_reconcile'); ?>",
            dataType: "json",
            data: data,
            success: function (data)
            {
    ...
    function delete_template() {
        ...
        $.ajax({
            type: "POST",
            url: "<?php echo site_url('report/report/delete_template_bank_reconcile'); ?>",
            dataType: "json",
            data: data,
            success: function (data)
            {
...
function submitForm() {
        ...
        $.ajax({
            url: "<?php echo site_url("report/report/do_upload_bank_reconcile")?>",
            type: "POST",
            data: datasend,
            processData: false,
            contentType: false
