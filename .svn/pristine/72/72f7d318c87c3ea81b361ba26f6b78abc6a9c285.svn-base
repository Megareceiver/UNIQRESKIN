...
include_once ($path_to_root . '/applications/mainpage.php');
...
include_once ($path_to_root . '/applications/accountantarea.php');
...
class front_accounting
{
    ...
    function display()
    {
        $theme_render_path = realpath(ROOT . "/themes/" . user_theme() . "/renderer.php");
        include_once ($theme_render_path);
    ...
    function init()
    {
        ...
        $this->add_application(new mainpage_app());
        ...
        $this->add_application(new accountantarea_app());
