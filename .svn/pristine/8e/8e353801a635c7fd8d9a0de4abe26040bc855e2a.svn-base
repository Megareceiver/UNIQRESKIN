...
$def_theme = "default";
echo "<link href='$path_to_root/themes/$def_theme/logout.css' rel='stylesheet' type='text/css'> \n";
include($path_to_root . "/includes/page/header.inc");
page_header(_("Logout"), true, false, '');
echo '<div class="form-logout">';
...
echo "</font></div></td>
  ...
  <tr>
    <td><div align='center'>";
echo "<a href='$path_to_root/index.php'>" . _("Click here to Login Again.") . "</a>";
echo "</div></td>
  </tr>
</table>
<br>\n";
