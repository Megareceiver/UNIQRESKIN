...
//         bug($this->bgColor);die;
        imagefill($this->gd, 0, 0, imagecolorallocate($this->gd, $r, $g, $b));

//         $color = imagecolorallocatealpha($this->gd, 0, 0, 0, 127); //fill transparent back
//         imagefill($this->gd, 0, 0, $color);
//         imagefill($this->gd,0,0,0x7fff0000);
//         $white = imagecolorallocatealpha($this->gd, 255, 255, 255, 127);
//         imagefill($this->gd, 0, 0, $white);
        ...
        if( $this->rotate != 0 ) {
            $this->gd = imagerotate($this->gd, $this->rotate, 0);
        }
