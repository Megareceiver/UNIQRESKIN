...
// $companyAssets = 'http://atcompanyasset.accountanttoday.net/';
...
$js_static = array(
    ...
    'plugins/bootstrap-4.0.0/js/bootstrap.min.js',
...
//     'plugins/bootstrap/css/bootstrap.css',
    'plugins/tether-1.3.3/css/tether.min.css',
...
// additional js source included in header
$js_lib = $css_lib = $js_userlib = array();

$assets_path = '//'.$_SERVER['HTTP_HOST'].'/assets/';

$js_document_ready = array();
