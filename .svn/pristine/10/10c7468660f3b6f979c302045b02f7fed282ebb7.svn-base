...
class AdminRevenueType {
    ...
    function __construct() {
        ...
        $this->ci = $ci;
        $this->db = $ci->db;
        $this->model = module_model_load('revenue','admin');
    ...
    function index(){
        ...
        page(_("Revenue Type"));
        start_form($multi=false, $dummy=false, $action=site_url('admin/revenue-type'));
        ...
        $table = & new_db_pager('revenue_type', $this->model->items_table(), $this->datatable_view);
