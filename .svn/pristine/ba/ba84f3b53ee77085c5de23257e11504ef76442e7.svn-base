...
//    $result_gl = get_gl_trans($_GET['type_id'], $_GET['trans_no']);
	...
	if ( file_exists ( $logo ) ){
		$html.= '<img src="'.$logo.'" style="max-height:90px;" >';
	} else {
		$html.='<h2>'.$company['coy_name'].'</h2>';
	}
	$html.='</td></tr><tr><td align="right"><h1 style="padding: 0; margin: 0;">PAYMENT VOUCHER</h1></td></tr></table></div>';
    ...
    $html.='<div class="content2">
            <table width=100% cellpadding=2 cellspacing=0 >
                ...
                <tr>
                    <td class="textbold">PAYEE</td>
                    <td>:</td>
                    <td>'.payment_person_name($from_trans['person_type_id'], $from_trans['person_id']).'</td>
                </tr>
                <tr>
                ...
                <tr>
                    <td class="textbold">Cheque Number</td>
                    <td>:</td>
                    <td>'.$from_trans['cheque'].'</td>
                </tr>
