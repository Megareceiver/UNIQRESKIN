...
$js_path = '//assets-dfao220aafpes34qa.uniq365.com/';
$assets_path = "//".$_SERVER['SERVER_NAME']."/assets/";

if( !defined('COMPANY_ASSETS') ) {
    define('COMPANY_ASSETS', '//companyasset.uniq365.com/'.$session->checkSubDirectory() );
}
if( !defined('COMPANY_DIR') ) {
    define('COMPANY_DIR', '/var/www/html/companyasset.accountanttoday.net/'.$session->checkSubDirectory() );
}
if( !defined('AT_ASSEETS') ) {
    define('AT_ASSEETS', '//'.$_SERVER['SERVER_NAME'].'/assets/');
    define('COUNTRY', 60);
